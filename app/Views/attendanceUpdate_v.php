            ...
            <form action="<?= base_url("/attendance/updateattendance/".$attendance_value['uiid'])?>" method="post" id="form">
                ...
                <div class="form-row row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="input form-control" type="datetime-local" size="15" value="<?=$attendance_value["time_in"]?>"  placeholder="Time In" name="time_in" id="etr" required>
                    </div>
                    <div class="col-sm-3">
                        <label for="eba"><b>Time Out:</b></label>
                        <input class="input form-control" type="datetime-local" size="15" value="<?=$attendance_value["time_out"]?>" placeholder="Time Out" name="time_out" id="eba" required>
                    </div>
                    <div class="col-sm-3">
